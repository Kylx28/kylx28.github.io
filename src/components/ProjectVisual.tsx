...
export function ProjectVisual({ project, compact = false }: { project: Project; compact?: boolean }) {
  return (
    <div className={`relative overflow-hidden border border-line bg-paper ${compact ? 'aspect-[4/3]' : 'aspect-[16/9]'}`}>
      ...
      {project.status && (
        <div className="absolute right-3 top-3 flex items-center gap-2 bg-paper/95 px-2.5 py-1.5 font-mono text-[9px] uppercase tracking-[0.08em] text-ink backdrop-blur-sm">
