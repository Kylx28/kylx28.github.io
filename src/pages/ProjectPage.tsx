    ...
    <article className="page-shell pt-10 sm:pt-16">
      ...
      <header className="grid gap-9 border-b border-ink pb-10 lg:grid-cols-[1.35fr_0.65fr] lg:gap-24">
        <div>
          ...
          <h1 className="max-w-4xl text-5xl font-medium leading-[0.95] tracking-[-0.055em] sm:text-7xl lg:text-[5.7rem]">{project.title}</h1>
      ...
      <div className="py-8 sm:py-12"><ProjectVisual project={project} /></div>
